...
These are examples of what is expected as the request and what should be returned as the response. Left out details assume what is specified in "Internship Report - Week 2". This is what is needed on the "Operator client".
